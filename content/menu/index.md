...
- **Payments**
  ...
  - [Tokenization]({{< relref "/docs/payments/token" >}})
  - [Client-Only Integration]({{< relref "/docs/payments/sdk-integration" >}})
  - [Client-Server Integration]({{< relref "/docs/payments/integration" >}})
